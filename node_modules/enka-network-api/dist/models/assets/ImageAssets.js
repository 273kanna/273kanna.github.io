...
class ImageAssets {
    constructor(name, enka) {
        ...
        this.enka = enka;
        this.name = name;
        this.imageBaseUrl = (_a = Object.keys(enka.options.imageBaseUrlByRegex).find(url => enka.options.imageBaseUrlByRegex[url].some(regex => regex.test(name)))) !== null && _a !== void 0 ? _a : enka.options.defaultImageBaseUrl;
